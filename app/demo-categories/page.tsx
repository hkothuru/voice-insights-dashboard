      ...
      <div className="space-y-4">
        <div>
          <h1 className="text-4xl font-bold tracking-tight bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">
            Demo Category Intelligence Dashboard
          </h1>
          <p className="text-xl text-muted-foreground mt-2">
            Sample dataset: {overallStats ? overallStats.totalCalls.toLocaleString() : '0'} buyer-seller conversations across {overallStats ? overallStats.totalCategories : '0'} product categories
          </p>
          <Badge variant="outline" className="mt-2">Sample Data for Demonstration</Badge>
        </div>
